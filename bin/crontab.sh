...
# just empty line
* * * * * /opt/bitnami/python/bin/curator --config=/curator/curator.yml /curator/actions/index_settings_fast.yml >> /curator/curator.log 2>&1
# just empty line
* * * * * /opt/bitnami/python/bin/curator --config=/curator/curator.yml /curator/actions/index_settings_slow.yml >> /curator/curator.log 2>&1
# just empty line
* * * * * /opt/bitnami/python/bin/curator --config=/curator/curator.yml /curator/actions/delete_index.yml >> /curator/curator.log 2>&1
